        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 20 }}>
            {[
              ...
              { icon: '🌺', title: 'Santé Féminine', desc: 'Suivi de cycle menstruel, symptômes, ovulation et rappels personnalisés inspirés de Flo.', href: '/sante-feminine', color: '#db2777', bg: '#fdf2f8' },
