...
const PLANS = [
  ...
  },
  {
    ...
    badge: 'Exclusif',
    services: [
      { icon:'👨‍⚕️', label:'Annuaire médecins vérifié', desc:'Gynécologues, sages-femmes vérifiés' },
      { icon:'💊', label:'Pharmacie en ligne', desc:'Médicaments et vitamines prénatales' },
      { icon:'🏥', label:'Cartographie maternités', desc:'Structures spécialisées accouchement' },
      { icon:'🤖', label:'Assistant IA Santé', desc:'Conseils grossesse personnalisés' },
      { icon:'📅', label:'Prise de rendez-vous', desc:'Consultation gynéco/sage-femme' },
    ],
    kit: [
      { icon:'🌸', label:'Serviettes hygiéniques', desc:'Post-accouchement incluses' },
    ],
    extras: [
      { icon:'🤰', label:'Suivi de Grossesse Complet', desc:'Calendrier prénatal OMS, visites, vaccins' },
      { icon:'💉', label:'Calendrier Vaccinal Prénatal', desc:'Tétanos, grippe, coqueluche — alertes' },
      { icon:'🛡️', label:'Espace Assurances', desc:'Assurance maternité et santé' },
      { icon:'💡', label:'Conseils Nutritionnels', desc:'Alimentation et suppléments adaptés' },
    ],
    kitLabel: 'Kit Maternité',
    kitColor: '#d97706',
  },
  {
    id: 'family',
